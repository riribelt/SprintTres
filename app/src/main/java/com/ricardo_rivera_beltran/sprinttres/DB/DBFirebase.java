package com.ricardo_rivera_beltran.sprinttres.DB;
...
import com.ricardo_rivera_beltran.sprinttres.Adaptadores.ProductoAdapter;
import com.ricardo_rivera_beltran.sprinttres.Entidades.Producto;
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                document.getReference().update(
                                        "name", producto.getName(),
                                             "name", producto.getDescription(),
                                            "name", producto.getPrice(),
                                            "name", producto.getLatitud(),
                                            "name", producto.getLongitud()
                                );
